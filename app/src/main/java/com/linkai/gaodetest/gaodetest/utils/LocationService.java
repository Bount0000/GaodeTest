package com.linkai.gaodetest.gaodetest.utils;
...
/**
 * Created by BUG-W on 2017/11/29.
 * AI功能：定位服务
 */
...
//                locationClient.setLocationListener(locationListener);
    ...
    AMapLocationListener locationListener = new AMapLocationListener() {
        ...
        public void onLocationChanged(AMapLocation location) {
            if (null != location) {
                ...
                Log.i(getClass().getName(),c);
            } else {
                Log.i(getClass().getName(),"定位失败，loc is nul");
    ...
    private void resetOption() {
        ...
        locationOption.setInterval(Long.valueOf(60000));
        // 设置网络请求超时时间
        locationOption.setHttpTimeOut(Long.valueOf(10000));
    }
